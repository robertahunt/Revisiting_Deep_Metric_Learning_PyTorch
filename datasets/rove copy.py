...
def Give(opt, datapath):
    ...
    val_genera = ['Achenium','Astenus','Lathrobium','Lithocharis','Lobrathium','Medon','Ochthephilum','Paederidus', 'Paederus',
    'Pseudomedon','Rugilus','Scopaeus','Sunius','Tetartopeus']
    test_genera = [x for x in genera if (x not in train_genera) and (x not in val_genera) ]
    ...
    eval_dataset  = BaseDataset(val_image_dict, opt, is_validation=True)
