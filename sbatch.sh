...
python main.py --dataset=rove --suffix=lifted7 --source_path=/home/ngw861/01_abbey_rove/data --seed=7 --bs=112 --samples_per_class=2  --loss=lifted --batch_mining=lifted --arch=resnet50_frozen --augmentation=rove
