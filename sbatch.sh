...
python main.py --dataset=rove --suffix=npair --source_path=/home/ngw861/01_abbey_rove/data --bs=32 --seed=1 --samples_per_class=2 --loss=npair --batch_mining=npair --arch=resnet50_frozen
