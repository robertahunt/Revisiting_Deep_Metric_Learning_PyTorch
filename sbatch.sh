...
python main.py --dataset=rove --suffix=arcface5 --source_path=/home/ngw861/01_abbey_rove/data --seed=5 --bs=112 --samples_per_class=2 --loss=arcface --arch=resnet50_frozen_normalize --augmentation=rove
