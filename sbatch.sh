...
python main.py --dataset=rove --suffix=tripD5 --source_path=/home/ngw861/01_abbey_rove/data --seed=5 --bs=112 --samples_per_class=2  --loss=triplet --batch_mining=distance --arch=resnet50_frozen_normalize --augmentation=rove
