...
def basic_training_parameters(parser):
    ...
    parser.add_argument(
        "--debug",
        action="store_true",
        help="Run only one batch, one epoch to test code",
    )
    parser.add_argument(
        "--kernels",
        default=6,
    ...
    parser.add_argument(
        ...
        type=str,
        help="Underlying network architecture. Frozen denotes that \
    ...
    parser.add_argument(
        ...
        type=str,
        help="The network may produce multiple embeddings (ModuleDict, relevant for e.g. DiVA). If the key is listed here, the entry will be evaluated on the evaluation metrics.\
...
def wandb_parameters(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        help="Name of the group - relates to W&B group names - all runs with same setup but different seeds are logged into one group. \
...
def loss_specific_parameters(parser):
    ...
    parser.add_argument(
        "--loss_triplet_margin", default=0.2, type=float, help="Margin for Triplet Loss"
    )

    ### MarginLoss
    parser.add_argument(
        "--loss_margin_margin", default=0.2, type=float, help="Triplet margin."
    )
    parser.add_argument(
        "--loss_margin_beta_lr",
        default=0.0005,
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help="Margin placed on similarities.",
    )
    parser.add_argument(
        "--loss_lifted_l2",
        default=0.005,
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help="Number of proxies per class.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=0.00001,
        type=float,
        help="Learning rate on class proxies.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--loss_snr_margin", default=0.2, type=float, help="Triplet margin."
    )
    parser.add_argument(
        "--loss_snr_reg_lambda",
        default=0.005,
...
def batch_creation_parameters(parser):
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help="Regularisation for D2-coreset.",
    )
    parser.add_argument(
        "--data_gc_coreset_lim",
        default=1e-9,
        type=float,
        help="D2-coreset value limit.",
    )
    parser.add_argument(
